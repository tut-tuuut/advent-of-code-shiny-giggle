...
example_1 = """on x=10..12,y=10..12,z=10..12
on x=11..13,y=11..13,z=11..13
off x=9..11,y=9..11,z=9..11
on x=10..10,y=10..10,z=10..10"""

example_2 = """on x=-20..26,y=-36..17,z=-47..7
...
def part_1(raw_input):
    ...
    for row in raw_input.splitlines():
        m = regex.match(row)
        x1, x2, y1, y2, z1, z2 = (int(g) for g in m.groups())
        onoff = 1 if row[1] == "n" else 0
...
def intersect_cuboids(a, b):
    xrange = intersect_segments(a[0], a[1], b[0], b[1])
    yrange = intersect_segments(a[2], a[3], b[2], b[3])
    zrange = intersect_segments(a[4], a[5], b[4], b[5])
