...
with open(os.path.join(os.path.dirname(__file__), "code.py.input.txt"), "r+") as file:
    raw_input = file.read()

# https://www.reddit.com/r/adventofcode/comments/a8s17l/2018_day_23_solutions/ecddus1/?utm_source=reddit&utm_medium=web2x&context=3
