...
class Instruction:
    def __init__(self, circuit, arg1, arg2):
        ...
        self.arg2 = arg2
        print(
            f"initialize instruction {self.__class__.__name__} with args {arg1} and {arg2}"
        )
...
class Circuit:
    ...
    def parseInstructions(self, instructionString):
        for instruction in filter(None, instructionString.split("\n")):
            ...
            if instruction[0:3] == "NOT" or re.match(
                r"([a-z\d]+) -> [a-z+]", instruction
            ):
                ...
                m = re.findall(
                    r"([a-z\d+]+) (AND|OR|LSHIFT|RSHIFT) ([a-z\d]+) ->", instruction
                )
